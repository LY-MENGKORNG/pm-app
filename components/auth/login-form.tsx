...
export default function LoginForm({
  ...
  function onSubmit() {
    const getMsgServerity = (variant: "primary" | "destructive") => ({
    ...
    toast.promise(handleLogin, {
      ...
      error: (error) => {
        ...
        return {
          ...
          style: getMsgServerity("destructive")
        }
      },
      position: "top-right",
    })
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      ...
      <FieldDescription className="px-6 text-center">
        By clicking continue, you agree to our <Link href="/term-services">Terms of Service</Link>{" "}
